 ...
 */
public class SalaryReportJson extends DataTableJson {
    ...
    public SalaryReportJson(Long id, User affiliateUser, String salary) {
    ...
    public SalaryReportJson(Long id, Company affiliateCompany, String salary) {
    ...
    public SalaryReportJson(Purchase purchase) {
        super(purchase);
    ...
    public SalaryReportJson(SalaryCorrection correction) {
        super(correction);
