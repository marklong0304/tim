...
$(function () {
    dataTable = $('#commissions').DataTable({
        ...
        "scrollCollapse": true,
        'ajax': {
            'url': context + 'reports/commission/get.json',
        ...
        'createdRow': function (row, data, index) {
            ...
            var purchaseLink = '<a id="' + purchaseId + '" class="text-center" href="' + context + 'reports/purchase/MyCommission/' + purchaseId + ' "> \
    ...
    $(window).bind('beforeunload', function () {
        if (updatedFields.length > 0) {
            return 'You have unsaved changes. Are you sure youwantn to leave without saving?';
        }
    });
});
